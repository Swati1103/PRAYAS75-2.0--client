    ...
    <div className="m-4 pb-4">
      <div>
        ...
        <p className="my-4 font-medium md:text-lg">
          ...
          scholarship, project mentorship and webinars. The members of Prayas75
        ...
        <p className="my-4 font-medium md:text-lg">
          ...
          academic performance in the first year (does not need to be in the top
          few). The selection is made either by each head of departments, or by
          Prayas75 selection committee. Each candidate is video interviewed
          before final award to ensure that they really need the support due to
          financial hardships and they are sincerely pursuing engineering with
          clean disciplinary record. The scholarship beneficiaries receive total
          of Rs 60,000 distributed in three years (second, third and the fourth
          years) as long as they are able to sustain their academic performance.
        </p>
      </div>
    </div>
  );
